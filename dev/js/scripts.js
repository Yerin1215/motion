...
shapeTL.to("#red-circle", { duration: 1, x: 700})
    .to("#red-circle", { duration: 1, x: 700, rotate: 720, scale: 3})
    .to("#red-circle", { duration: 1, x: 200, ease: 'elastic', width: 500})
    .to("#red-circle", { duration: 1, x: 500, scale: -3, width:30})
    .to("#red-circle", { duration: 1, x: 30, rotate: 90})
    .to("#red-circle", { duration: 1, x: 2000})
    .to("#red-circle", { duration: 1, x: -150})
    .to("#red-circle", { duration: 1, x: -150, rotate: 180})
    .to("#red-circle", { duration: 1, ease: 'elastic', width: 60, height: 60});
